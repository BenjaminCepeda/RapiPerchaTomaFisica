 ...
 * @date 2020/12/06
 */
public class FrmReporteOrdenTomaFisica extends javax.swing.JFrame {
     ...
     */
    public FrmReporteOrdenTomaFisica(EmpleadoVO empleadoLogueado, 
    ...
    private FrmReporteOrdenTomaFisica() {
    ...
    private void btnImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirReporteActionPerformed
      if(!txtOrdenBuscada.getText().isEmpty() && 
            ...
            reporte=JasperCompileManager.compileReport("src/ec/com/kodice/rapipercha/reporte/reportDetalledeOrdenV2.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmReporteOrdenTomaFisica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmReporteOrdenTomaFisica().setVisible(true);
            }
        });
    }
