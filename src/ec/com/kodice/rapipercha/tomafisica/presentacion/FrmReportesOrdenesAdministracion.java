 ...
 * @date 2020/12/06
 */
public class FrmReportesOrdenesAdministracion extends javax.swing.JFrame {
     ...
     */
    public FrmReportesOrdenesAdministracion(EmpleadoVO empleadoLogueado, 
    ...
    private FrmReportesOrdenesAdministracion() {
        //dtpFecha.setDateToToday();
        //cargarTabla(dtpFecha.getDate());
    }
    ...
    private void btnImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirReporteActionPerformed
        ...
        try {
            ...
            reporte=JasperCompileManager.compileReport("src/ec/com/kodice/rapipercha/reporte/reportOrdenes.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmReportesOrdenesAdministracion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmReportesOrdenesAdministracion().setVisible(true);
            }
        });
    }
